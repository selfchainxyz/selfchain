...
# set your variables:
MNEMONIC="nice educate snow nurse nest hero question vintage volume runway step magnet south bullet busy soft cargo food degree random satoshi math sport ski"
PASSPHRASE="qwaszxqw"
...
docker exec -it $VALIDATOR1_ID selfchaind tx bank send self10hyl92j27zuwvu7rrvr6aa5ems2xjfd9q9zgun self1hux078uv4zyt76fn2ym0aag5lnh820yduqclx2 5000000000000000uslf --from wallet1 --chain-id self-1 --gas auto --fees 500uslf
docker exec -it $VALIDATOR1_ID selfchaind tx bank send self10hyl92j27zuwvu7rrvr6aa5ems2xjfd9q9zgun self1rnh49xguhdulz0zckke4r9l4ckw4jhstlvudds 5000000000000000uslf --chain-id self-1 --gas auto --fees 500uslf
...
docker exec -it $VALIDATOR1_ID selfchaind query account self1c0h75n6pfnl9pk80dktqnjwvqgz0tu2trfwg40
