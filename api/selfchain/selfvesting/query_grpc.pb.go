...
const (
	Query_Params_FullMethodName              = "/selfchain.selfvesting.Query/Params"
	Query_VestingPositions_FullMethodName    = "/selfchain.selfvesting.Query/VestingPositions"
	Query_VestingPositionsAll_FullMethodName = "/selfchain.selfvesting.Query/VestingPositionsAll"
)
...
func (c *queryClient) VestingPositions(ctx context.Context, in *QueryGetVestingPositionsRequest, opts ...grpc.CallOption) (*QueryGetVestingPositionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VestingPositions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VestingPositionsAll(ctx context.Context, in *QueryAllVestingPositionsRequest, opts ...grpc.CallOption) (*QueryAllVestingPositionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VestingPositionsAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) VestingPositions(context.Context, *QueryGetVestingPositionsRequest) (*QueryGetVestingPositionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VestingPositions not implemented")
}
func (UnimplementedQueryServer) VestingPositionsAll(context.Context, *QueryAllVestingPositionsRequest) (*QueryAllVestingPositionsResponse, error) {
...
func _Query_VestingPositions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VestingPositions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_VestingPositionsAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VestingPositionsAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
