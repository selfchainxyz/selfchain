...
type MsgRelease struct {
	...
	PosIndex string `protobuf:"bytes,2,opt,name=posIndex,proto3" json:"posIndex,omitempty"`
}
...
func (m *MsgRelease) GetPosIndex() string {
	if m != nil {
		return m.PosIndex
	}
	return ""
...
func (m *MsgReleaseResponse) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
var fileDescriptor_70a0f46b1e8b78ab = []byte{
	...
	,
}
...
func (m *MsgRelease) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PosIndex) > 0 {
		i -= len(m.PosIndex)
		copy(dAtA[i:], m.PosIndex)
		i = encodeVarintTx(dAtA, i, uint64(len(m.PosIndex)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *MsgRelease) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.PosIndex = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
