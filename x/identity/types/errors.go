...
var (
	...
	ErrInvalidOAuthProvider  = sdkerrors.Register(ModuleName, 300, "invalid OAuth provider")
	ErrInvalidOAuthToken     = sdkerrors.Register(ModuleName, 301, "invalid OAuth token")
	ErrOAuthVerification     = sdkerrors.Register(ModuleName, 302, "OAuth verification failed")
	ErrInvalidToken          = sdkerrors.Register(ModuleName, 303, "invalid OAuth token")
	ErrInvalidProvider       = sdkerrors.Register(ModuleName, 304, "invalid OAuth provider")
	ErrProviderNotFound      = sdkerrors.Register(ModuleName, 305, "OAuth provider not found")
	ErrTokenExpired          = sdkerrors.Register(ModuleName, 306, "OAuth token expired")
	ErrTokenVerification     = sdkerrors.Register(ModuleName, 307, "OAuth token verification failed")
	ErrInvalidTokenClaims    = sdkerrors.Register(ModuleName, 308, "invalid OAuth token claims")
	ErrInvalidTokenScope     = sdkerrors.Register(ModuleName, 309, "invalid OAuth token scope")
	ErrInvalidTokenResponse  = sdkerrors.Register(ModuleName, 310, "invalid OAuth token response")
	ErrOAuthProviderNotFound = sdkerrors.Register(ModuleName, 311, "oauth provider not found")
	ErrInvalidOAuthConfig    = sdkerrors.Register(ModuleName, 312, "invalid OAuth configuration")
